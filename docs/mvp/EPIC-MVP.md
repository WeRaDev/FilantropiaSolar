...
**Maps:** D10  
**Status:** Automated gates green; local CRM script signed; **TRL5 deployed** NC **3.2.26** + Odoo **19.0.2.22.0**; **fleet seeded** (11 public stations + CRM leads). Optional: browser analytics smoke on TRL5.  
