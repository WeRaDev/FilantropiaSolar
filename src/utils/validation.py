...
class ValidationSchema:
    ...
    def _apply_rule(self, value: Any, rule: ValidationRule, field_name: str) -> ValidationResult:
        ...
        try:
            ...
            result.add_error(f"Validation error in {field_name}: {str(e)}")
            logger.warning(f"Validation exception in {field_name}: {e}")
        
        return result
    
    def _validate_type(self, value: Any, rule: ValidationRule, field_name: str) -> ValidationResult:
        """Validate value type."""
        result = ValidationResult(is_valid=True, sanitized_value=value)
    ...
    def _validate_range(self, value: Any, rule: ValidationRule, field_name: str) -> ValidationResult:
        ...
        try:
            ...
            result.add_error(f"Cannot validate range for non-numeric value in {field_name}")
            return result
    ...
    def _validate_format(self, value: Any, rule: ValidationRule, field_name: str) -> ValidationResult:
        ...
        if format_type == 'email':
            ...
            try:
                datetime.strptime(str_value, rule.parameters.get('date_format', '%Y-%m-%d'))
            except ValueError:
                result.add_error(rule.error_message)
    ...
    def _validate_length(self, value: Any, rule: ValidationRule, field_name: str) -> ValidationResult:
    ...
    def _validate_pattern(self, value: Any, rule: ValidationRule, field_name: str) -> ValidationResult:
    ...
    def _validate_enum(self, value: Any, rule: ValidationRule, field_name: str) -> ValidationResult:
    ...
    def _validate_custom(self, value: Any, rule: ValidationRule, field_name: str) -> ValidationResult:
...
class InputValidator:
    ...
    def validate_numeric(
        ...
        convert_to_type: Optional[Type] = None,
        field_name: str = "input"
    ...
    def validate_file_path(
        ...
        if allowed_extensions and path_value.suffix.lower() not in [ext.lower() for ext in allowed_extensions]:
            raise ValidationError(
