...
class OutputWindow:
    ...
    def _create_widgets(self):
        ...
        title_label = ttk.Label(
            main_frame, text="Prediction Results & Analysis", font=("Arial", 16, "bold")
        )
    ...
    def _update_summary_display(self):
        ...
        try:
            ...
            ttk.Label(self.summary_frame, text="Location:").grid(
            ...
            ttk.Label(self.summary_frame, text="Capacity:").grid(
                row=row, column=0, sticky=tk.W, padx=(20, 10)
            )
            ttk.Label(
                self.summary_frame,
            ...
            ttk.Label(
                self.summary_frame, text="Prediction Period", font=("Arial", 12, "bold")
            ).grid(row=row, column=0, columnspan=2, sticky=tk.W, pady=(0, 10))
            row += 1

            ttk.Label(self.summary_frame, text="Start Date:").grid(
                row=row, column=0, sticky=tk.W, padx=(20, 10)
            )
            ttk.Label(
                self.summary_frame,
            ...
            ttk.Label(self.summary_frame, text="End Date:").grid(
                row=row, column=0, sticky=tk.W, padx=(20, 10)
            )
            ttk.Label(
                self.summary_frame,
            ...
            ttk.Label(self.summary_frame, text="Center Date:").grid(
                row=row, column=0, sticky=tk.W, padx=(20, 10)
            )
            ttk.Label(
                self.summary_frame,
            ...
            ttk.Label(self.summary_frame, text="Total Energy:").grid(
                row=row, column=0, sticky=tk.W, padx=(20, 10)
            )
            ttk.Label(
                self.summary_frame,
            ...
            ttk.Label(self.summary_frame, text="Average Specific Energy:").grid(
                row=row, column=0, sticky=tk.W, padx=(20, 10)
            )
            ttk.Label(
                self.summary_frame,
            ...
            ttk.Label(self.summary_frame, text="Peak Energy Hour:").grid(
                row=row, column=0, sticky=tk.W, padx=(20, 10)
            )
            ttk.Label(
                self.summary_frame,
            ...
            ttk.Label(self.summary_frame, text="Data Type:").grid(
                row=row, column=0, sticky=tk.W, padx=(20, 10)
            )
            ttk.Label(
                self.summary_frame, text=data_type, font=("Arial", 10, "bold")
            ).grid(row=row, column=1, sticky=tk.W)
            row += 1

            ttk.Label(self.summary_frame, text="Model Used:").grid(
                row=row, column=0, sticky=tk.W, padx=(20, 10)
            )
            ttk.Label(
                self.summary_frame,
