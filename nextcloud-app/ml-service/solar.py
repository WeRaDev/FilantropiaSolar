...
def calculate_solar_elevations_batch(
    ...
    """
    return [calculate_solar_elevation(ts, latitude, longitude) for ts in timestamps]
...
def calculate_sunrise_sunset(
    ...
    Args:
        ...
        latitude: Latitude in degrees
        _longitude: Longitude in degrees (accepted for API symmetry; local solar
            time is longitude-independent by definition)
