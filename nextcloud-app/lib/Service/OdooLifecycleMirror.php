...
'is_public' => StationLifecycle::isPublic($state, $soft, (bool) $station->getPublicArchived()),
			'public_category' => StationLifecycle::publicCategory($state, $soft, (bool) $station->getPublicArchived()),
			'soft_removed' => $soft,
